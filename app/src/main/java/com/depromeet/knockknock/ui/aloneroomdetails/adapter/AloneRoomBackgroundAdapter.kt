package com.depromeet.knockknock.ui.aloneroomdetails.adapter
...
class AloneRoomBackgroundAdapter(
    private val eventListener: AloneRoomDetailsActionHandler
) : ListAdapter<Background, AloneRoomBackgroundAdapter.ViewHolder>(BackgroundListItemDiffCallback){
