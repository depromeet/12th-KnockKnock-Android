...
class CreateRoomWithFriendAdapter(
    private val eventListener: CreateRoomWithFriendActionHandler
) : ListAdapter<Friend, CreateRoomWithFriendAdapter.ViewHolder>(InviteFriendListItemDiffCallback){
