...
class EditRoomDetailsFragment :
    ...
    override fun initAfterBinding() {
        ...
        backgroundAdapter.submitList(testList)
        ...
        val thumbnailTestList = listOf(thumbnailTest1, thumbnailTest2, thumbnailTest3,thumbnailTest4)
        thumbnailAdapter.submitList(thumbnailTestList)
    }
