package com.depromeet.knockknock.ui.aloneroommakecategory.adapter
...
import com.depromeet.knockknock.ui.aloneroommakecategory.AloneRoomMakeCategoryActionHandler

var beforeClicked = 0

class AloneRoomMakeCategoryAdapter(
    private val eventListener: AloneRoomMakeCategoryActionHandler
) : ListAdapter<Category, AloneRoomMakeCategoryAdapter.ViewHolder>(FriendListItemDiffCallback){
